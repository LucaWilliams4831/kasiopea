...
import (
	...
	"github.com/sipt/kasiopea/dns"
	"github.com/sipt/kasiopea/extension/network"
	"github.com/sipt/kasiopea/log"
	"github.com/sipt/kasiopea/proxy"
	"github.com/sipt/kasiopea/rule"

	_ "github.com/sipt/kasiopea/ciphers"
	_ "github.com/sipt/kasiopea/proxy/protocol"
	_ "github.com/sipt/kasiopea/proxy/selector"
)
...
func main() {
	configPath := flag.String("c", "kasiopea.yaml", "configuration file path")
...
func loadConfig(configPath string) (conf *config.Config, err error) {
	...
	//init HttpMap
	if err = kasiopea.ApplyHTTPModifyConfig(conf); err != nil {
		return
	}
	//init MITM
	if err = kasiopea.ApplyMITMConfig(conf); err != nil {
		return
	}
	return
}
